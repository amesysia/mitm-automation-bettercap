...
I set the parameters. After that, I was ready to start spoofing.
...
The first thing I did was configure hstshijack file. For this, I opened another tab in this terminal session by clicking Session in the top left corner, then typed:
...
I added sites such as LinkedIn, X, and YouTube. I pressed CTRL +X, confirmed saving by pressing Y, and then hit Enter.
...
It worked, but typing the exact same configurations over and over again while troubleshooting gave me an idea. If caplets are essentially scripts meant to prevent typing the same lines repeatedly, why not write my own custom caplet?
...
net.sniff on
I tried using my own caplet and it worked like a charm. I was ready to use hstshijack now.

I ran my mymitm caplet first to set up the spoof, then ran hstshijack. I went to my Windows machine and tested several sites. I typed google.com, linkedin.com, x.com, and youtube.com in the URL bar. All of them loaded fine and the connection remained secure. So the downgrade attack failed.
...
I ran Bettercap again, started my custom mymitm caplet first, typed hstshijack, and pressed Tab. Bettercap successfully auto-completed the path this time and executed the caplet without any errors. This caplet included more target sites and configurations.
...
I was using the Supermium browser. I tried clearing all browser data, turning off built-in protection settings, and disabling ‘Secure DNS’, but the result was the same.
